...
func TestValidate(t *testing.T) {
	tests := []struct {
		...
		{
			// A typo has to be an error, not a silent downgrade: reading
			// CONDUIT_LOCK=redlok as "none" would drop the guard against
			// duplicate execution without saying anything.
			name: "an unknown lock strategy is invalid",
			cfg: models.Config{
				Transport: models.TransportPostgres,
				Lock:      "redlok",
				HTTP:      models.HTTPConfig{Address: ":8080", ReadTimeout: 5e9, WriteTimeout: 5e9},
		...
		{
			name: "an unknown transport is invalid",
			cfg: models.Config{
				Transport: "rabbit",
				Lock:      models.LockAdvisory,
				HTTP:      models.HTTPConfig{Address: ":8080", ReadTimeout: 5e9, WriteTimeout: 5e9},
		...
		{
			// The whole point of the Postgres transport: no broker configured is
			// not a misconfiguration, because no client gets built.
			name: "the postgres transport needs no broker",
			cfg: models.Config{
				Transport: models.TransportPostgres,
				Lock:      models.LockNone,
				HTTP:      models.HTTPConfig{Address: ":8080", ReadTimeout: 5e9, WriteTimeout: 5e9},
				Postgres:  models.PostgresConfig{DSN: "postgres://localhost/conduit"},
				Worker:    models.WorkerConfig{Concurrency: 4, QueueSize: 32},
				Webhook:   models.WebhookConfig{Timeout: time.Second},
		...
		{
			name: "the kafka transport needs a broker",
			cfg: models.Config{
				Transport: models.TransportKafka,
				Lock:      models.LockAdvisory,
				HTTP:      models.HTTPConfig{Address: ":8080", ReadTimeout: 5e9, WriteTimeout: 5e9},
				Postgres:  models.PostgresConfig{DSN: "postgres://localhost/conduit"},
				Worker:    models.WorkerConfig{Concurrency: 4, QueueSize: 32},
		...
		{
			name: "redlock needs redis addresses",
			cfg: models.Config{
				Transport: models.TransportPostgres,
				Lock:      models.LockRedlock,
				HTTP:      models.HTTPConfig{Address: ":8080", ReadTimeout: 5e9, WriteTimeout: 5e9},
				Postgres:  models.PostgresConfig{DSN: "postgres://localhost/conduit"},
				Worker:    models.WorkerConfig{Concurrency: 4, QueueSize: 32},
				Webhook:   models.WebhookConfig{Timeout: time.Second},
